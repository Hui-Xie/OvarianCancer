...
input: 100 3D radiomics feature in index space:
           "/home/hxie1/data/BES_3K/W512NumpyVolumes/log/SurfacesNet/expBES3K_20201126A_genXml/testResult/volume3D_s5tos7_100radiomics_indexSpace"
...
radiomicsDir = "/home/hxie1/data/BES_3K/W512NumpyVolumes/log/SurfacesNet/expBES3K_20201126A_genXml/testResult/volume3D_s5tos6_100radiomics_indexSpace"
...
hintName= "3DThickRadioClinic_s5tos6_IndexSpace_10CV"  # Thickness Radiomics Clinical
...
def main():
    ...
    print("")
    print(f"====={hintName}======================")
    print(f"==========input features: radiomics={numRadiomics}, thickness={numThickness}, clinical={numClinicalFtr}==============")
    print(
        "===============================================================================================================")
    print(
        "CV,  #TrainningSamples,  #ValidationSamples, #TestSamples, #TrainingAccuracy, #ValidationAccuray, #TestAccuracy,")
