...
def main():
    ...
    volumePathsFile = os.path.join(hps.dataDir, "All"+ "_VolumePaths.txt")
    IDsCorrespondVolumesPathFile = os.path.join(hps.dataDir, "All" + "_IDsCorrespondVolumes.txt")
    ...
    print(f"All data set including OS/OD: NVolumes={NVolumes}\n")
    rate1 = targetLabels.sum() * 1.0 / NVolumes
    rate0 = 1 - rate1
    print(f"All data set: proportion of 0,1 = [{rate0},{rate1}]\n")
