...
class ThicknessMap2HyperTensionNet_VGG16C(BasicModel):
    def __init__(self, hps=None):
        ...
        self.m_conv4 = nn.Sequential(
            ...
            nn.Conv2d(hps.channels[3], hps.channels[3], kernel_size=(1, 9), stride=(1, 2), padding=0, bias=True),
            # nn.BatchNorm2d(hps.channels[3]),  # do not use norm before FC.
        ...
        self.m_fc1 = nn.Linear(hps.channels[3], 1)  # only one FC layer
