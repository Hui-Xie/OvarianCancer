...
#rawLatentDir = "/home/hxie1/data/OvarianCancerCT/primaryROI1_1_3/LatentCrossValidation/rawLatent_20191210_024607"
#extractLatentDir = "/home/hxie1/data/OvarianCancerCT/primaryROI1_1_3/LatentCrossValidation/extractLatent_20191210_024607"

rawLatentDir = "/home/hxie1/data/OvarianCancerCT/primaryROI1_1_3/training/latent/latent_20191210_024607"
extractLatentDir = "/home/hxie1/data/OvarianCancerCT/primaryROI1_1_3/training/latent/extractLatent_20191210_024607"
...
filesList = getFilesList(rawLatentDir, suffix)

for i, filePath in enumerate(filesList):
    dir, filename = os.path.split(filePath)
    x = np.load(filePath)
    assert (rawF,) == x.shape
    outputx= x[featureIndices]
    assert (F,) == outputx.shape
    np.save(os.path.join(extractLatentDir, filename), outputx)
