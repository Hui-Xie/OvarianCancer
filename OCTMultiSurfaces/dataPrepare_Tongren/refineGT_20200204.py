...
5   sort along all columns for all patients:  done.
      this step can solve all disorder of surface 7, 8,9, and the disorder of surface 1,2,3,4, 5 near foveas;
      as doctor' suggested solution 1 (merge surfaces 1,2,3,4,5 in macular) is  very difficult to program: program is difficult to automatically locate foveas regions (macular), and it is difficult to judge how many A-Scan to merge.
...
outputDir = "/home/hxie1/data/OCT_Tongren/markError_20200204"
...
def main():
    ...
    5   sort along all columns for all patients:
      this step can solve all disorder of surface 7, 8,9, and the disorder of surface 1,2,3,4, 5 near foveas;
      as doctor' suggested solution 1 (merge surfaces 1,2,3,4,5 in macular) is  very difficult to program: 
      program is difficult to automatically locate foveas regions (macula), and it is difficult to judge how many A-Scan to merge.
