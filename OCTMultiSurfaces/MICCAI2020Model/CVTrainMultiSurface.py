...
def main():
    ...
    trainData = OCTDataSet(trainImagesPath, trainLabelsPath, trainIDPath, transform=trainTransform, device=device, sigma=sigma, lacingWidth=lacingWidth, TTA=False, TTA_Degree=0)
