...
# June 23rd, 2021: Put ReLU outside of loss
...
class SurfacesUnet_YufanHe_3(BasicModel):  #
    ''''
    ...
    def forward(self, inputs, gaussianGTs=None, GTs=None, layerGTs=None, riftGTs=None):
        ...
        # put ReLU outside of Loss computation
        if 1 == self.hps.hardSeparation: #ReLU to guarantee layer order
            for i in range(1, N):
