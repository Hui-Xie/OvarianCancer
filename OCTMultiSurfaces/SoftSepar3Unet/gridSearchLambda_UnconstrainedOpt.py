...
'''
surfaces: /home/hxie1/data/OCT_Duke/numpy_slices/log/SurfaceSubnet/expDuke_20200902A_SurfaceSubnet/testResult/validation
thickness: /home/hxie1/data/OCT_Duke/numpy_slices/log/ThicknessSubnet_Z4/expDuke_20210204D_Thickness_YufanHe_FullHeightConv_iibi007/testResult/validation
'''
...
lambda1_min, lambda1_max, lambda1_step = 1, 2, 0.01
...
def main():
    ...
    with open(outputRecordFilename, "w") as file:
        ...
        file.write(f"min location mu error with optimizaiton on 2 branches = {muErrorArray[j,i]}\n")
