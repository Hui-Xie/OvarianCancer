# direct use N-1 thickness with softmax and crossentropy
...
class ThicknessSubnet_N(BasicModel):  #
    ''''
    ...
    def forward(self, inputs, gaussianGTs=None, GTs=None, layerGTs=None, riftGTs=None):
        ...
        xt = self.m_thicknesses(x)  # output size: B*(numSurfaces-1)*H*W, xt mean x_thickness, and xs mean x_surface
