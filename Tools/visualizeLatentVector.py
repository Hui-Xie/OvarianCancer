...
"""
for i in range(0, nCount0, 20): # print part
    print(Fore.RED + str(array0[:, i].tolist()))
for i in range(0, nCount1, 20):  # print part
...
subplot0 = plt.subplot(2,1,1)
subplot0.plot(xAxis, array0mean-array0std, xAxis, array0mean, xAxis, array0mean+ array0std)
subplot0.set_xlabel('Element Position')
subplot0.set_ylabel('Element Value')
subplot0.legend(('mu-std', 'mu', 'mu+std'))
subplot0.set_title('Response 0')

subplot1 = plt.subplot(2,1,2)
subplot1.plot(xAxis, array1mean-array1std, xAxis, array1mean, xAxis, array1mean+ array1std)
subplot1.set_xlabel('Element Position')
subplot1.set_ylabel('Element Value')
subplot1.legend(('mu-std', 'mu', 'mu+std'))
subplot1.set_title('Response 1')
