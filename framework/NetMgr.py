...
class NetMgr:
    ...
    def saveNet(self, netPath=None):
        ...
        torch.save(self.m_net.m_configParameterDict, os.path.join(netPath, "ConfigParameters.pt"))
    ...
    def loadNet(self, mode):
        ...
        if os.path.exists(os.path.join(self.m_netPath, "ConfigParameters.pt")):
            self.m_net.m_configParameterDict = torch.load(os.path.join(self.m_netPath, "ConfigParameters.pt"))
        if mode == "train":
