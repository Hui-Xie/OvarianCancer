...
class SegV2DModel(SegVModel):
    def __init__(self, C, K):
        ...
        self.m_down1 = Down2dBB(C, C, (5, 5), stride=(2, 2))            # output:C*139*139
        self.m_down2 = Down2dBB(C, 2 * C, (3, 3), stride=(2, 2))        # output: 2C*69*69
        ...
        self.m_up1   = Up2dBB(2 * C, C, (5, 5), stride=(2, 2))          # output:C*281*281
